...
//         className="fixed bottom-6 right-8 z-50 bg-green-500 hover:bg-green-600 active:bg-green-700 
//                    text-white rounded-full p-4 shadow-xl shadow-green-500/50 
...
//         <button
//           onClick={scrollToTop}
//           className="fixed bottom-24 right-8 z-50 bg-purple-600 hover:bg-purple-700 active:bg-purple-800
//                      text-white rounded-full p-4 shadow-xl shadow-purple-500/50 
//                      transition-all duration-300 hover:scale-110 active:scale-95
